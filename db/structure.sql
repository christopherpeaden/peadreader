...
--
-- Name: fk_rails_36f9216dc2; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY feeds
    ADD CONSTRAINT fk_rails_36f9216dc2 FOREIGN KEY (user_id) REFERENCES users(id);
...
INSERT INTO schema_migrations (version) VALUES ('20150726020240');

INSERT INTO schema_migrations (version) VALUES ('20150726025441');

INSERT INTO schema_migrations (version) VALUES ('20150726160431');

INSERT INTO schema_migrations (version) VALUES ('20150726160702');

INSERT INTO schema_migrations (version) VALUES ('20150813000514');

INSERT INTO schema_migrations (version) VALUES ('20150814152111');
